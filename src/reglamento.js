...
const REGLAMENTO = {
  es: {
    ...
    campos: {
      ...
      habitacion: 'N.° de habitación (opcional)',
      fecha: 'Fecha',
      firma: 'Firma',
    },
    ui: {
      ...
      errorCampos: 'Complete el nombre y el número de documento.',
  ...
  en: {
    ...
    campos: {
      ...
      habitacion: 'Room number (optional)',
      fecha: 'Date',
      firma: 'Signature',
    },
    ui: {
      ...
      errorCampos: 'Fill in the name and ID number.',
